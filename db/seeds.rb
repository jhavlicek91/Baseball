...
Team.create(name: 'Yankees', division_id: 1, city_id: 1, name_abbreviation: 'NYY', primaryColor: '#132448', secondaryColor: '#CDCBCE', rssFeedID: 'nyy')
Team.create(name: 'Red Sox', division_id: 1, city_id: 2, name_abbreviation: 'BOS', primaryColor: '#0E2B55', secondaryColor: '#BD3039', rssFeedID: 'bos')
Team.create(name: 'Orioles', division_id: 1, city_id: 5, name_abbreviation: 'BAL', primaryColor: '#020001', secondaryColor: '#DF4601', rssFeedID: 'bal')
Team.create(name: 'Blue Jays', division_id: 1, city_id: 4, name_abbreviation: 'TOR', primaryColor: '#0067A6', secondaryColor: '#A5A5A5', rssFeedID: 'tor')
Team.create(name: 'Rays', division_id: 1, city_id: 3, name_abbreviation: 'TB', primaryColor: '#00285D', secondaryColor: '#79BDEE', rssFeedID: 'tb')

Team.create(name: 'Mets', division_id: 2, city_id: 1, name_abbreviation: 'NYM', primaryColor: '#004685', secondaryColor: '#F7742C', rssFeedID: 'nym')
Team.create(name: 'Phillies', division_id: 2, city_id: 11, name_abbreviation: 'PHI', primaryColor: '#CA1F2C', secondaryColor: '#226AA9', rssFeedID: 'phi')
Team.create(name: 'Nationals', division_id: 2, city_id: 12, name_abbreviation: 'WAS', primaryColor: '#14225A', secondaryColor: '#BA122B', rssFeedID: 'was')
Team.create(name: 'Braves', division_id: 2, city_id: 14, name_abbreviation: 'ATL', primaryColor: '#01487E', secondaryColor: '#D60D39', rssFeedID: 'atl')
Team.create(name: 'Marlins', division_id: 2, city_id: 13, name_abbreviation: 'FLA', primaryColor: '#333333', secondaryColor: '#00A5B1', rssFeedID: 'mia')

Team.create(name: 'Tigers', division_id: 3, city_id: 8, name_abbreviation: 'DET', primaryColor: '#10293F', secondaryColor: '#FFFFFF', rssFeedID: 'det')
Team.create(name: 'Twins', division_id: 3, city_id: 9, name_abbreviation: 'MIN', primaryColor: '#042462', secondaryColor: '#B50131', rssFeedID: 'min')
Team.create(name: 'White Sox', division_id: 3, city_id: 6, name_abbreviation: 'CHW', primaryColor: '#000000 ', secondaryColor: '#FFFFFF', rssFeedID: 'cws')
Team.create(name: 'Indians', division_id: 3, city_id: 10, name_abbreviation: 'CLE', primaryColor: '#023465', secondaryColor: '#EE113D', rssFeedID: 'cle')
Team.create(name: 'Royals', division_id: 3, city_id: 7, name_abbreviation: 'KAN', primaryColor: '#000572', secondaryColor: '#FFFFFF', rssFeedID: 'kc')

Team.create(name: 'Cardinals', division_id: 4, city_id: 15, name_abbreviation: 'STL', primaryColor: '#C41E3A', secondaryColor: '#FFFFFF', rssFeedID: 'stl')
Team.create(name: 'Brewers', division_id: 4, city_id: 17, name_abbreviation: 'MIL', primaryColor: '#012143', secondaryColor: '#C4953B', rssFeedID: 'mil')
Team.create(name: 'Cubs', division_id: 4, city_id: 6, name_abbreviation: 'CHC', primaryColor: '#0E3386', secondaryColor: '#D12325', rssFeedID: 'chc')
Team.create(name: 'Pirates', division_id: 4, city_id: 18, name_abbreviation: 'PIT', primaryColor: '#000000', secondaryColor: '#FFB40B', rssFeedID: 'pit')
Team.create(name: 'Reds', division_id: 4, city_id: 16, name_abbreviation: 'CIN', primaryColor: '#EB184B', secondaryColor: '#FFFFFF', rssFeedID: 'cin')

Team.create(name: 'Athletics', division_id: 5, city_id: 20, name_abbreviation: 'OAK', primaryColor: '#00483A', secondaryColor: '#FFBE00', rssFeedID: 'oak')
Team.create(name: 'Angels', division_id: 5, city_id: 19, name_abbreviation: 'LAA', primaryColor: '#CE1141', secondaryColor: '#FFFFFF', rssFeedID: 'ana')
Team.create(name: 'Mariners', division_id: 5, city_id: 23, name_abbreviation: 'SEA', primaryColor: '#003166', secondaryColor: '#1C8B85', rssFeedID: 'sea')
Team.create(name: 'Rangers', division_id: 5, city_id: 22, name_abbreviation: 'TEX', primaryColor: '#01317B', secondaryColor: '#E00016', rssFeedID: 'tex')
Team.create(name: 'Astros', division_id: 5, city_id: 21, name_abbreviation: 'HOU', primaryColor: '#95322c', secondaryColor: '#C7B39A', rssFeedID: 'hou')

Team.create(name: 'Dodgers', division_id: 6, city_id: 19, name_abbreviation: 'LAD', primaryColor: '#005596', secondaryColor: '#FFFFFF', rssFeedID: 'la')
Team.create(name: 'Diamondbacks', division_id: 6, city_id: 24, name_abbreviation: 'ARI', primaryColor: '#C51230', secondaryColor: '#241E20', rssFeedID: 'ari')
Team.create(name: 'Rockies', division_id: 6, city_id: 25, name_abbreviation: 'COL', primaryColor: '#000000', secondaryColor: '#333366', rssFeedID: 'col')
Team.create(name: 'Padres', division_id: 6, city_id: 26, name_abbreviation: 'SD', primaryColor: '#1C3465', secondaryColor: '#CCC59B', rssFeedID: 'sd')
Team.create(name: 'Giants', division_id: 6, city_id: 27, name_abbreviation: 'SF', primaryColor: '#000000', secondaryColor: '#FB5B1F', rssFeedID: 'sf')
